  ...
  return (
    <>
      ...
      <section className="relative py-16 sm:py-20 lg:py-24 bg-[#F2F2F2]">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <h2 className="font-playfair font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-dark-gray mb-6 sm:mb-8 lg:mb-12">
              ABOUT US
            </h2>
            ...
            <p className="font-poppins text-sm sm:text-base lg:text-lg text-black leading-relaxed">
      ...
      <section className="relative py-16 sm:py-20 lg:py-24 bg-cream">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 relative z-10">
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            <h2 className="font-playfair font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-dark-gray mb-6 sm:mb-8">
              TIMELINE
            </h2>
      ...
      <section className="relative py-16 sm:py-20 lg:py-24 bg-[#F2F2F2]">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10 max-w-7xl mx-auto">
            {/* Testimonial 1 */}
            <div className="bg-white/70 backdrop-blur-sm border border-[#DDDDDD] rounded-2xl p-6 sm:p-8 shadow-card">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="font-poppins text-xs sm:text-sm text-gray-600">Frontend Developer</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/70 backdrop-blur-sm border border-[#DDDDDD] rounded-2xl p-6 sm:p-8 shadow-card">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="font-poppins text-xs sm:text-sm text-gray-600">UI/UX Designer</p>
                </div>
              </div>
            </div>

            {/* Testimonial 3 */}
            <div className="bg-white/70 backdrop-blur-sm border border-[#DDDDDD] rounded-2xl p-6 sm:p-8 shadow-card md:col-span-2 lg:col-span-1">
              <p className="font-poppins text-sm sm:text-base text-black leading-relaxed mb-6">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="font-poppins text-xs sm:text-sm text-gray-600">Full Stack Developer</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 sm:py-24 lg:py-32 bg-dark-gray">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <h2 className="font-playfair font-bold text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-white mb-6 sm:mb-8 lg:mb-12">
              READY TO BUILD?
            </h2>
            <div className="flex items-center justify-center space-x-4 sm:space-x-6 mb-8 sm:mb-12 lg:mb-16">
            ...
            <p className="font-poppins text-base sm:text-lg lg:text-xl text-white/80 leading-relaxed mb-10 sm:mb-12 lg:mb-16">
            ...
            <button className="bg-white shadow-button rounded-xl px-10 sm:px-16 lg:px-20 py-4 sm:py-5 lg:py-6 hover:bg-gray-100 transition-colors">
